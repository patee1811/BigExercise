...
void ThreatsObject::Show(SDL_Renderer* des)
{
    if (come_back_time_ == 0)
    {
        ...
        SDL_Rect* currentClip = &frame_clip_[frame_]; // anh hien tai
        SDL_Rect rendQuad = {rect_.x, rect_.y, width_frame_, height_frame_}; // vi tri kich thuoc cua frame
